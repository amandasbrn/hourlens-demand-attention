...
PRED_PATH = Path("outputs/predictions/lstm_attn_predictions.parquet")
METRICS_PATH = Path("outputs/evaluation/lstm_attn_metrics.csv")
CHECKPOINT_PATH = Path("outputs/checkpoints/lstm_attn.pt")
